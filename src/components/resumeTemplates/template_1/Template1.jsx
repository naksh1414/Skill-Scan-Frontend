// src/components/templates/Template1/Template1.jsx
...
function Template1() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="shadow-lg w-full overflow-scroll sbar lg:overflow-hidden  order-2">
        <div
          ref={resumeRef}
          className="min-w-[210mm] max-w-full min-h-[297mm]  mx-auto bg-white p-8"
          style={{
            minHeight: "297mm",
          }}
          id="prnt"
